        ...
        <div className='about-container'>
          <div className='profile-container'>
            ...
            <p>
              ...
              tech didn’t come from a traditional computer science background,
              but rather from a genuine curiosity and drive to learn. When I'm
              not coding, you'll find me capturing memories through photos and
              vlogs or diving into Riot/Steam games.
            </p>
          </div>
          ...
          <div className='tech-stack'>
            ...
            <div className='tech-grid'>
              ...
              <div className='tech-icon' title='Jest'>
                <i className='devicon-jest-plain colored'></i>
              </div>
              <div className='tech-icon' title='ESLint'>
                <i className='devicon-eslint-plain colored'></i>
              </div>
